...
using System.Linq;
using ApiCoreDio.Data.Collections;
using ApiCoreDio.Models;
using Microsoft.AspNetCore.Mvc;
using MongoDB.Driver;

namespace ApiCoreDio.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class InfectadoController : ControllerBase
    {
        ...
        {
            Infectado infectado = new Infectado(dto.DataNascimento, dto.Sexo, dto.Latitude, dto.Longitude);
